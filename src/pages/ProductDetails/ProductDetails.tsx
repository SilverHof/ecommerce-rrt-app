...
export const ProductDetails = () => {
   ...
   const current_index = products.findIndex(product => product.id === productId);
   
   return (
      <main className="main">
         <section className="product-details__container container">
            <div className="product-details__inner">
               <div className="product-details__head">
                  <ProductImageBox 
                     images={products[current_index].array_of_images}
                  />
                  <ProductAbout 
                     information={products[current_index].information}
                     characteristics={products[current_index].characteristics}
                  />
                  <ProductActions 
                     price={products[current_index].price}
                  />
               </div>
               <ProductComments 
                  comments={products[current_index].comments}
               />
            </div>
         </section>
      </main>
